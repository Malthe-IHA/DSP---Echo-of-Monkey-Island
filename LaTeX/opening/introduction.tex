...
Expanding on the echo subject, we look at generating the effect of a \emph{chorus} \fxerror{It is impotent to notice difference between chorus and harmonies!}, starting with a single vocal track. As part of this, we wish to generate multiple vocal tracks, with slight changes in the audio delay (From the echo project), as well as modulating the frequencies, to simulate the effect of different singers.
...
\end{itemize}
\fxnote{Den sidste kan vi måske ikke lave}